...
export class ReportsGuard implements CanActivate {
  ...
  canActivate(
    route: ActivatedRouteSnapshot,
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    if (this.authService.user_permissions.reports) {
      return true;
    } else {
      if (this.authService.user_permissions.dashboard) {
        this.router.navigate(["/", URLS.home]);
...
export class SMSConfigurationsGuard implements CanActivate {
  constructor(
    private authService: AuthService,
    private router: Router
  ) { }
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    if (this.authService.user_permissions.configuration) {
      if (this.authService.user_permissions.sms_configurations) {
        return true;
      } else {
        if (this.authService.user_permissions.dashboard) {
          this.router.navigate(["/", URLS.home]);
...
export class EmailConfigurationsGuard implements CanActivate {
  constructor(
    private authService: AuthService,
    private router: Router
  ) { }
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    if (this.authService.user_permissions.configuration) {
      if (this.authService.user_permissions.email_configurations) {
        return true;
      } else {
        if (this.authService.user_permissions.dashboard) {
          this.router.navigate(["/", URLS.home]);
...
export class CacheSettingGuard implements CanActivate {
  constructor(
    private authService: AuthService,
    private router: Router
  ) { }
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    if (this.authService.user_permissions.configuration) {
      if (this.authService.user_permissions.cache_settings) {
        return true;
      } else {
        if (this.authService.user_permissions.dashboard) {
          this.router.navigate(["/", URLS.home]);
...
export class PreferencesGuard implements CanActivate {
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    if (this.authService.user_permissions.configuration) {
      if (this.authService.user_permissions.preferences) {
        return true;
      } else {
        if (this.authService.user_permissions.dashboard) {
          this.router.navigate(["/", URLS.home]);
...
export class MultiLocationGuard implements CanActivate {
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    if (this.authService.user_permissions.configuration) {
      if (this.authService.user_permissions.multi_location) {
        return true;
      } else {
        if (this.authService.user_permissions.dashboard) {
          this.router.navigate(["/", URLS.home]);
...
export class ErpGuard implements CanActivate {
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    if (this.authService.user_permissions.configuration) {
      if (this.authService.user_permissions.erp) {
        return true;
      } else {
        if (this.authService.user_permissions.dashboard) {
          this.router.navigate(["/", URLS.home]);
...
export class CourierGuard implements CanActivate {
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    if (this.authService.user_permissions.configuration) {
      if (this.authService.user_permissions.courier) {
        return true;
      } else {
        if (this.authService.user_permissions.dashboard) {
          this.router.navigate(["/", URLS.home]);
...
export class FeaturedAppsGuard implements CanActivate {
  constructor(
    private authService: AuthService,
    private router: Router
  ) { }
...
export class SizeChartGuard implements CanActivate {
  constructor(
    private authService: AuthService,
    private router: Router
  ) { }
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    if (this.authService.user_permissions.featured_apps) {
      if (this.authService.user_permissions.sizechart) {
        return true;
      } else {
        if (this.authService.user_permissions.dashboard) {
          this.router.navigate(["/", URLS.home]);
...
export class WishListGuard implements CanActivate {
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    if (this.authService.user_permissions.featured_apps) {
      if (this.authService.user_permissions.wishlist) {
        return true;
      } else {
        if (this.authService.user_permissions.dashboard) {
          this.router.navigate(["/", URLS.home]);
...
export class TimeSlotGuard implements CanActivate {
  constructor(
    private authService: AuthService,
    private router: Router
  ) { }
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    if (this.authService.user_permissions.featured_apps) {
      if (this.authService.user_permissions.timeslot) {
        return true;
      } else {
        if (this.authService.user_permissions.dashboard) {
          this.router.navigate(["/", URLS.home]);
...
export class JobPostingGuard implements CanActivate {
  constructor(
    private authService: AuthService,
    private router: Router
  ) { }
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    if (this.authService.user_permissions.featured_apps) {
      if (this.authService.user_permissions.job_posting) {
        return true;
      } else {
        if (this.authService.user_permissions.dashboard) {
          this.router.navigate(["/", URLS.home]);
...
export class StoreLocatorGuard implements CanActivate {
  constructor(
    private authService: AuthService,
    private router: Router
  ) { }
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    if (this.authService.user_permissions.featured_apps) {
      if (this.authService.user_permissions.storelocator) {
        return true;
      } else {
        if (this.authService.user_permissions.dashboard) {
          this.router.navigate(["/", URLS.home]);
...
export class OrderReturnGuard implements CanActivate {
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    if (this.authService.user_permissions.featured_apps) {
      if (this.authService.user_permissions.order_return) {
        return true;
      } else {
        if (this.authService.user_permissions.dashboard) {
          this.router.navigate(["/", URLS.home]);
